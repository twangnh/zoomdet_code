...
class PackDetInputs(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        ori_inputs = ((results['ori_inputs'] - mean) / std).astype(np.float32)
        ori_inputs = ori_inputs[..., [2, 1, 0]]
        data_sample.ori_inputs = to_tensor(ori_inputs).permute(2, 0, 1).contiguous()
        data_sample.ori_gt_bboxes = results['ori_gt_bboxes']
