...
from .dota_orig import dotaorigDataset
from .seadronesee import seadroneseeDataset
...
__all__ = [
    ...
    'ADE20KInstanceDataset', 'iSAIDDataset', 'V3DetDataset', 'ConcatDataset','xViewDataset', 'sodadDataset', 'kittiDataset', 'tinypersonDataset', 'dotaDataset',
    'uavdtDataset', 'dotaorigDataset', 'seadroneseeDataset', 'mscocoDataset', 'argoverseDataset'
]
